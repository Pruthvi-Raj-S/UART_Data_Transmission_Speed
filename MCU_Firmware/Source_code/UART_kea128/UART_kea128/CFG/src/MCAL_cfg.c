...
*							INTERNAL VARIABLES
******************************************************************************/
/* structure initialization for System clock in FEE mode
 for generating 40MHz using external 8MHz crystal */
ICS_ConfigType ICS_Config =
{
	.u8ClkMode=ICS_CLK_MODE_FEE,	/*!< clock mode to be switched */
	.bLPEnable=0,					/*!< low power mode enable */
    .bdiv=DCO_DIVIDED_BY_1,			/*!< core fre= DCO */
	/*!< OSC configuration */
	.oscConfig.bRange=1,			/*!< 1: high range, 0: low range */
	.oscConfig.bGain=1,			/*!< 1: high gain, 0: low gain */
	.oscConfig.bEnable=1,			/*!< 1: enable XOSC, 0: disable XOSC */
	.oscConfig.bStopEnable=0,		/*!< 1: stop enable, 0: stop disable */
	.oscConfig.bIsCryst=1,		/*!< 1: crystal input, 0: active clock input */
	.oscConfig.bWaitInit=1,		/*!< 1: wait till XOSC Init done, 0: no wait */
	.oscConfig.u32OscFreq=8000		/*!< oscillator clock frequency in KHz */
};
